...
`;
		...
		function LegacyResources({ t }) {
			...
			const restore = async () => {
				...
				setError(void 0);
				try {
					if (!(await fetch("/auth/legacy-resources", {
						method: "POST",
						credentials: "same-origin",
						headers: { "content-type": "application/json" },
						body: JSON.stringify({ confirmedUserId: account.identity.userId })
					})).ok) throw new Error(t("loadFailed"));
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
				...
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("h4", {
						...
						children: t("legacyTitle")
					}),
					counts && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("p", { children: [
						t("legacyCount"),
						": Workspace ",
						counts.workspaces,
						" · Session ",
					...
					account && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("p", { children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
						...
						}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: t("legacyConfirm") })]
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Button, {
						type: "button",
						variant: "outline",
						size: "sm",
						disabled: !confirmed || busy || !account || !counts || !(counts.sessions + counts.workspaces),
						onClick: restore,
						children: t("legacyRestore")
					}),
		...
		function TenantSettingsTab({ t }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("form", {
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)(LegacyResources, { t }),
